...
'ru' => [
  ...
  'cats.title'=>'Категории', 'cats.sub'=>'Добавляйте и редактируйте категории новостей (двуязычные).',
  ...
  'post.author'=>'Автор:', 'post.edit'=>'Редактировать',
  ...
  // moderation
  'mod.title'=>'Модерация', 'mod.queue'=>'{n} в очереди',
...
'en' => [
  ...
  'cats.title'=>'Categories', 'cats.sub'=>'Add and edit news categories (bilingual).',
  ...
  'post.author'=>'Author:', 'post.edit'=>'Edit',
  ...
  'mod.title'=>'Moderation', 'mod.queue'=>'{n} in queue',
